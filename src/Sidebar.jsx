...
{
  /* Definición de los iconos SVG como rutas */
}
const icons = {
...
const Icon = ({ name, className }) => {
  ...
  {
    /* Manejo de error si el icono no se encuentra */
  }
  if (typeof icon === "string") {
    {
      /* Si el icono es una cadena (como "home"), renderiza directamente la ruta */
    }
    return (
      <svg
  ...
  {
    /* Si el icono es un objeto (como "login"), usa sus propiedades específicas */
  }
  return (
    <svg
      className={`shrink-0 w-5 h-5 ${className}`}
...
export function Sidebar() {
  ...
  return (
    <>
      {/* Botón para togglear el sidebar en pantallas pequeñas */}
      <button
                  ...
                  {({ isActive }) => (
                    <>
                      <Icon
                        ...
                        viewBox={link.viewBox || "0 0 20 20"}
                      />
