export function Navbar({ logoImg, NombreDelBlog }) {
  const linkClasses =
  ...
  return (
    <nav className="bg-white border-gray-200 dark:bg-gray-900">
      <div className="flex flex-wrap items-center justify-between mx-auto p-4 ml-10 mr-10">
        ...
        >
          <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <a href="/Mi-Blog/" className={linkClasses}>
                Inicio
              </a>
            </li>
            <li>
              <a href="/acerca-de/" className={linkClasses}>
                Acerca de
              </a>
            </li>
            <li>
              <a href="/servicios/" className={linkClasses}>
                Servicios
              </a>
            </li>
          </ul>
